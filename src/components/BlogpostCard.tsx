...
export default function BlogpostCard({ data }: PostProps) {
  return (
    <div
      className="group relative overflow-hidden rounded-lg border border-gray-200 bg-white shadow-md transition-all hover:shadow-lg
        "
    >
      <Link href={`/post/${data.blogId}`} className="block w-full h-full">
        ...
        <div className="p-4 ">
            <h3 className="mb-2 text-lg font-semicold  text-gray-900">{data.title}</h3>
